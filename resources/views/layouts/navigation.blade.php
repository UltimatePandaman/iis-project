        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="mr-2 flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                            <div>Admin</div>
                    ...
                    <x-slot name="content">
                        ...
                        <x-dropdown-link href="/admin/users">Manage users</x-dropdown-link>
                ...
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <!-- Authentication -->
                        <form method="GET" action="{{ route('profile.edit', ['user' => Auth::user()]) }}">
                            @csrf
