...
Route::post('/presentation/delete/{presentation}', 'App\Http\Controllers\PresentationController@accept')->middleware(['auth']);
...
Route::get('/room/{room}/edit', 'App\Http\Controllers\RoomController@edit');
Route::patch('/room/{room}', 'App\Http\Controllers\RoomController@update');
...
Route::patch('/conference/{conference}', 'App\Http\Controllers\ConferencesController@update');
Route::get('/conference/{conference}/edit', 'App\Http\Controllers\ConferencesController@edit');
